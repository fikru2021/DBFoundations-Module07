...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_FikruAbasori')
	 Begin 
	  Alter Database [Assignment07DB_FikruAbasori] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_FikruAbasori;
	 End
	Create Database Assignment07DB_FikruAbasori;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_FikruAbasori;
...
Order by 1, CAST ([InventoryDate] AS Date),2
GO 
